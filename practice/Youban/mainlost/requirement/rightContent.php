...
if($ownTZinfo){
	...
	echo '<div class="perDetaile">
							<div class="personFace">
								<a class="face" href="javascript:void(0);"><img class="seeother"  width="50px" height="50px" username='.$value['username'].' src="'.$userinfo['headpic'].'" alt=""></a>
							</div>
							<div class="detail">
