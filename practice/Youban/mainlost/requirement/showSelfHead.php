<?php
    ...
    if(isset($_SESSION['username']) && trim($_SESSION['username'])){
       $start=0;
        ...
        $ownTZinfo = $mydb->getData('*', 'tiezi', 'status=1 AND fatherID=0 AND username="'.$username.'"', 'tzaddtimes DESC',$start,$page);
			  ...
			  <div class="container-fluid">
			    ...
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			      <ul class="nav navbar-nav navbar-right">
			        ...
			        <li class="lr">
				        <img class="userphoto" src="<?=$owninfo['headpic']?>" width="20px" height="20px" alt="">
				        <?php
